    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item">
              <router-link class="nav-link navbar-text" to="/AdminDash/AnF">User Management</router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link navbar-text" to="/AdminDash/CampaignsFlagging">Campaigns management</router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link navbar-text" to="/AdminDash/Stats">Stats</router-link>
            </li>
            <li class="nav-item">
