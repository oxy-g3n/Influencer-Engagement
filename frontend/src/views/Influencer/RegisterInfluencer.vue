    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 mx-auto">
          <h2 class="text-center text-white mb-4">Influencer Registration</h2>
          <form @submit.prevent="registerInfluencer" class="form-container border p-4 border-primary rounded">
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-group mb-3">
                  ...
                  <input type="text" id="niche" v-model="formData.niche" class="form-control" required>
                </div>
                <div class="form-group mb-3">
                  <label for="reach">Reach:</label>
                  <input type="number" id="reach" v-model="formData.reach" class="form-control" required min="0" max="100000000">
                </div>
                <div class="form-group mb-3">
...
export default {
  ...
  methods: {
    async registerInfluencer() {
      ...
      formData.append('action', 'influencer_reg');
